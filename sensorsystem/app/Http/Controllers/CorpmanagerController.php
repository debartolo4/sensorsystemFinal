...
class CorpmanagerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/users')->with('success', 'Nuovo responsabile aziendale aggiunto con successo');
    }
    ...
    public function show($id)
    {
        ...
        if(Auth::user()-> type == 1) {
            ...
            return view('corpManager.show')->with('corpManager', $corpManager);
        } else {
            return view('employee.corpManagers.showCorpManager')->with('corpManager', $corpManager);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/users')->with('success', 'Responsabile aziendale modificato con successo');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/users')->with('success', 'Responsabile aziendale rimosso con successo');
    }
    ...
    {
            $corpManager = Auth::user();
            $corpManager->password = bcrypt($request->get('password'));
            $corpManager->firstLog = 1;
            $corpManager->save();
