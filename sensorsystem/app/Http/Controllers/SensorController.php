...
class SensorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Auth::user()->type == 1) {
            ...
            return redirect('/corpManager/sensors')->with('success', 'Sensore installato con successo');
        }
    }
    ...
    public function show($id)
    {
        ...
        if(Auth::user()-> type == 1) {
            ...
            return view('corpManager.sensors.showSensor')->with('sensor', $sensor);
        } else {
            return view('employee.sensors.showSensor')->with('sensor', $sensor);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if(Auth::user()->type == 1) {
            ...
            return view ('corpManager.sensors.editSensor')->with('sensor', $sensor);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Auth::user()->type == 1) {
            ...
            return redirect('/corpManager/sensors')->with('success', 'Sensore modificato con successo');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if(Auth::user()->type == 1) {
            ...
            return redirect('corpManager/sensors')->with('success', 'Sensore rimosso con successo');
        }
    }
}
