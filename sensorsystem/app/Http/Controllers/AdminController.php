...
class AdminController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if(Auth::user()-> type == 1) {
            ...
            return view('corpManager.admins.showAdmin')->with('admin', $admin);
        } else {
            return view('employee.admins.showAdmin')->with('admin', $admin);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/users')->with('success', 'Admin modificato con successo');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/users')->with('success', 'Admin rimosso con successo');
    }
}
