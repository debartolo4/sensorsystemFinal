                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="type_id" class="form-control" name="type_id">
                                    <?php
                                    use App\Customer;use Illuminate\Support\Facades\Auth;use Illuminate\Support\Facades\DB;$types = \App\SensorType::all();
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="site_id" class="form-control" name="site_id">
                                    <?php
                                    $sites = DB::select('SELECT * FROM sites WHERE client_id = ' .Auth::user()->client_id. ';');
                                    ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a type="button" href="/corpManager/sensors" class="btn btn-default">
                                    Annulla
                                </a>
